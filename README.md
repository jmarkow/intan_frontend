...
6. [Filename Options](#filename-options)
6. [Script Options](#script-options)
...
There are lots of options to specify how things run "under-the-hood", e.g. the spectrogram parameters, sensitivity of vocalization detection, what directories to use, etc.  All options are specified using parameter/value pairs (examples are given below the table).  Here's the full list:
