...
[sonogram_im sonogram_f sonogram_t]=zftftb_pretty_sonogram(DATA.(SOURCE).norm_data,fs,'len',16.7,'overlap',3.3,'clipping',[-2 2]);
...
for i=1:size(EXT_PTS,1)
	...
	[chunk_sonogram_im chunk_sonogram_f chunk_sonogram_t]=zftftb_pretty_sonogram(EXTDATA.(SOURCE).norm_data,fs,'len',16.7,'overlap',10,'clipping',[-2 2]);
